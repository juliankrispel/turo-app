 ...
 ************************************************************/
  ...
  clearPressed: function() { 
    this.turoStringCursorPosition = 0;
  ...
  writerPressed: function(e) {
    ...
    if (states.ENTER_PRESSED === self.state) {
      ...
      case "REPLACE":
        ...
        this.editableExpression = new editableExpression.EditableExpression('', 0).insert(e);
        break;
      default:
 ...
 ************************************************************/
  ...
  beginEditing: function(statement) {
    ...
    if (statement) {
      ...
      this.turoStringCursorPosition = lineToCursor.length || 0;
    }
