var test = require('tap').test,
    ...
    expressionEditor = require('../lib/app/expression-src-editor.js'),
...
function testAppend (t, editor, oldString, expectedString, token, result) {
  ...
  var obj = editor.append(oldString, result, token),
      newString = obj.string;

  t.equal(newString, expectedString, "Append: " + oldString + " + '" + token.key+ "' -> " + newString + ' expected: ' + expectedString);
}
...
test('Valid result, just after parensClose', function (t) {
  ...
  testAppend(t, editor, '(1+2)', '1/(1+2)', {
    key: '1/',
    type: 'prefixOp'
  });

  testAppend(t, editor, '(2', '(1/2', {
    key: '1/',
    type: 'prefixOp'
  });
...
test('Valid result, insert', function (t) {
  ...
  testInserts(t, editor, '1.0 kg/metre^2', token, ['sin(1.0 kg/metre^2', 'sin(1.0 kg/metre^2', 'sin(1.0 kg/metre^2',
                                                'sin(1.0 kg/metre^2', 'sin(1.0 kg/metre^2', 'sin(1.0 kg/metre^2',
                                                'sin(1.0 kg/metre^2', 'sin(1.0 kg/metre^2', 'sin(1.0 kg/metre^2',
                                                'sin(1.0 kg/metre^2', 'sin(1.0 kg/metre^2', 'sin(1.0 kg/metre^2',
                                                'sin(1.0 kg/metre^2', 'sin(1.0 kg/metre^2' ]); 

  testInserts(t, editor, '1.0 metre^2', token, ['sin(1.0 metre^2', 'sin(1.0 metre^2', 'sin(1.0 metre^2', 
                                              'sin(1.0 metre^2', 'sin(1.0 metre^2', 'sin(1.0 metre^2', 
                                              'sin(1.0 metre^2', 'sin(1.0 metre^2', 'sin(1.0 metre^2', 
                                              'sin(1.0 metre^2', 'sin(1.0 metre^2', 'sin(1.0 metre^2' ]);
...
test('Valid result, delete', function (t) {
  ...
  testDelete(t, editor, '(1.0)', 0, '(1.0)');
  testDelete(t, editor, '(1.0)', 1, '1.0');
  testDelete(t, editor, '(1.0)', 2, '(.0)');
  testDelete(t, editor, '(1.0)', 3, '(10)');
  testDelete(t, editor, '(1.0)', 4, '(1.)');
  testDelete(t, editor, '(1.0)', 5, '1.0');

  turo.evaluate('xyz = 1.0');

  testDelete(t, editor, '(xyz)', 0, '(xyz)');
  testDelete(t, editor, '(xyz)', 1, 'xyz');
  testDelete(t, editor, '(xyz)', 2, '()');
  testDelete(t, editor, '(xyz)', 3, '()');
  testDelete(t, editor, '(xyz)', 4, '()');
  testDelete(t, editor, '(xyz)', 5, 'xyz');

  testDelete(t, editor, '1+xyz', 0, '1+xyz');
  testDelete(t, editor, '1+xyz', 1, '+xyz');
  testDelete(t, editor, '1+xyz', 2, '1xyz');
  testDelete(t, editor, '1+xyz', 3, '1+');
  testDelete(t, editor, '1+xyz', 4, '1+');
  testDelete(t, editor, '1+xyz', 5, '1+');
...
test('Valid result, delete from units', function (t) {
  ...
  testDelete(t, editor, '12 metre*3 metre', 9, '12 metre3 metre');
